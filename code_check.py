...
class CodeCheck():
    ...
    def __check_advance_chessboard (self):
        ...
        if not self.__check_result(chessboard, [[5, 5]]):
            self.__check_result(chessboard, [[5, 5]])
            self.errorcase = 1
            return False
        ...
        if not self.__check_result(chessboard, [[1, 9]]):
            self.__check_result(chessboard, [[1, 9]])
            self.errorcase = 2
            return False
        ...
        if not self.__check_result(chessboard, [[4, 2]]):
            self.__check_result(chessboard, [[4, 2]])
            self.errorcase = 3
            return False
        ...
        if not self.__check_result(chessboard, [[5, 2]]):
            self.__check_result(chessboard, [[5, 2]])
            self.errorcase = 4
            return False
        ...
        if not self.__check_result(chessboard, [[2, 3]]):
            self.__check_result(chessboard, [[2, 3]])
            self.errorcase = 5
            return False
        return True
